...
- Fichero de VM (ViewModel): Encargado de hacer la llamadas que tiene almacenadas el repositorio, y almacenarlas en el modelo (visual) para entregarselo a la vista.
